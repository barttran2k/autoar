    ...
    try:
        ...
        try:
            if options[selected_option]["options"][selected_sub_option]["options"] is not None:
                ...
                if values[selected_sub_option] == "1":
                    option_value = ""
                else:
                    option_value = input_option_value(option_name)
                values[selected_sub_option] = {"name": option_name, "value": option_value, "arg":option_arg}
    ...
    try:
        if not selected_option:
            ...
            if selected_option.isnumeric():
                ...
                selected_option = ""
            elif selected_option != "R" and not selected_option.isnumeric():
